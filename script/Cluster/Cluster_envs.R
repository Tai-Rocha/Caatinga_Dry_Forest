...
caatinga_matrix_pvclus_<- read.csv("./data/tables/New/Input_Distance_Pvclust/input_distance_final_pvclust.csv", sep = ",", dec= ".")

cluster <-pvclust(caatinga_matrix_pvclus_[,-1], method.hclust ="average", method.dist = "euclidean", nboot=1000)


plot(cluster, print.pv=c("si","au", "bp"), print.num=TRUE, float=0.01,
